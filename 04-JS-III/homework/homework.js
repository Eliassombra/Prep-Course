...
function mesesDelAño(array) {
  ...
  for (var i = 0; i < array.length; i++){
    if (array[i] === "Enero" || array[i] === "Marzo" || array[i] === "Noviembre")
      arrayCaja.push(array [i]);
  }
  if (arrayCaja.includes("Enero") && arrayCaja.includes("Marzo") && arrayCaja.includes("Noviembre")){
    return arrayCaja
  } else {
...
function breakStatement(numero) {
  ...
  if (arrayCaja.length < 10){
    return "Se interrumpió la ejecución"
  } else if(arrayCaja.length === 10){
    return arrayCaja;
  }
}
